...
- [Deep Learning with PyTorch - Vocabulary (1106 words)](#deep-learning-with-pytorch---vocabulary-1106-words)
...
## Deep Learning with PyTorch - Vocabulary (1106 words)
...
- `internal`  /ɪnˈtɜːrnl/ <br> of or on the inside: He has internal injuries (= inside his body) - the internal structure of a building - internal doors  (OPPOSITE: external)
- `staggering (adjective)`  /ˈstæg.ər.ɪŋ/ <br> very shocking and surprising: A staggering set of operations involving 88.6 million parameters
- `akin (adjective)`  /əˈkɪn/ <br> having some of the same qualities: They speak a language akin to French
- `ascending (adjective)`  /əˈsend.ɪŋ/ <br> increasing in order, from smallest to largest: the sort function sorts values in ascending order - The numbers are listed in ascending order: 1, 3, 5, 9.
- `descending (adjective)`  /dɪˈsend.ɪŋ/ <br> decreasing in order, from largest to smallest: sorts the values in ascending or descending order - The results are shown in descending order: 9, 5, 3, 1.
- `indices`  <br> plural of index
- `misunderstand (verb)`  /ˌmɪsʌndərˈstænd/ <br> to not understand something correctly or to understand it in the wrong way: I think you misunderstood what I meant
- `subtle (adjective)`  /ˈsʌt.əl/ <br> not large, bright, obvious or easy to notice: subtle colors - There has been a subtle change in her behavior - There's a subtle difference between the two colors
- `bias (noun)`  /ˈbaɪ.əs/ <br> a strong feeling in favor of or against something, often not based on fair judgment: how easy it is for strange, subtle biases to sneak into our data - The study was criticized for having a bias toward younger participants. - تعصب، سوگیری، جانبداری
- `sneak (verb)`  /sniːk/ <br> to go somewhere or do something secretly and quietly, without being noticed: how easy it is for strange, subtle biases to sneak into our data - He tried to sneak out of the house without waking anyone.
...
- `coordinate (noun)`  /koʊˈɔːr.dɪ.nət/ <br> a set of numbers (like x, y) used to show the exact position of a point on a graph, map, or space:The coordinates (3, 5) mark a specific point on the graph
- `following (adjective)`  /ˈfɑː.loʊ.ɪŋ/ <br> next in time or order; coming right after: As we will see in the following chapter - Please read the following instructions carefully
- `expressively (adverb)`  /ɪkˈspres.ɪv.li/ <br> in a way that clearly communicates meaning, feeling, or ideas: She spoke very expressively, making the story come alive
- `particularly`  /pərˈtɪkjələrli/ <br> especially, or more than usual: We're particularly interested to hear from people who speak two or more European languages - I didn't particularly want to go, but I had to
- `meaningful (adjective)`  /ˈmiː.nɪŋ.fəl/ <br> having real importance, purpose, or value; making sense: We had a meaningful conversation about our future
- `essence (noun)`  /ˈes.əns/ <br> the basic or most important idea or quality of something: Simplicity is the essence of good design
- `allocate (verb)`  /ˈæl.ə.keɪt/ <br> to give something (like time, money, or memory) officially to a particular person, task, or purpose; to set something apart for a specific use: The teacher allocated ten minutes for each presentation
- `contiguous (adjective)`  /kənˈtɪɡ.ju.əs/ <br> next to each other in an unbroken sequence, without any gaps or breaks: The two houses are contiguous, sharing a wall - The three contiguous parking spots were all empty
...
- `precision (noun)`  /prəˈsɪʒ.ən/ <br> the quality of being exact: Scientific calculations require a high level of precision
- `buy (verb)`  /baɪ/ <br> 1. to get something by paying money <br> 2. (figurative) to obtain or achieve something; to produce a result or benefit
- `minor (adjective)`  /ˈmaɪnər/ <br> not very big or important: Don't worry _ It's only a minor problem - a minor road (OPPOSITE: major)
- `predicate (noun)`  /ˈpred.ɪ.kət/ <br> a statement or condition that can be either true or false; in programming, an expression that checks each element and returns a boolean (true/false) result: x > 5 is a predicate that returns true or false depending on the value of x
- `cast (verb)`  /kæst/ <br> (programming) to convert a value from one data type to another: You need to cast the integer to a float before dividing
- `conversion (noun)`  /kənˈvɜːrʒn/ <br> the act or process of converting/changing something from one form, type, or unit to another: The conversion of the file from PDF to Word took a few seconds
...
- `wrong (adjective)`  /rɑːŋ/ <br> 1. not true or not correct: She gave me the wrong key, so I couldn't open the door - This clock is wrong (OPPOSITE: right) <br> 2. not the best: We took the wrong road and got lost (OPPOSITE: right) <br> 3. not as it should be, or not working well: There's something wrong with my car _ it won't start - 'What's wrong with Judith?' 'She's got a cold' <br> 4. bad, or not what the law allows: Stealing is wrong - I haven't done anything wrong (OPPOSITE: right)
