...
## ساختار کلی (Structure)

`Subject + would + verb (base form)`

> would شکل گذشته‌ی will است، اما کاربردهای مستقل زیادی دارد.

---

## 1. تصور کردن موقعیت یا کار (Imagining)

**معنی:** ... خوب/عالی می‌شد (اما واقعیت ندارد)

- **It would be nice** to buy a new car, but we can't afford it.
- **I would love to** live by the ocean.

**برای پیشنهاد دادن (به‌معنای «اگر جای تو بودم...»):**

- Should I tell Chris about what happened?
- No, **I wouldn't say anything.** (اگر جای تو بودم چیزی نمی‌گفتم)

> این ساختار هم برای پیشنهاد دادن به کار می‌رود، هم برای پیشنهاد ندادن.

---

## 2. گذشته (Would Have)

**معنی:** در گذشته اینطور می‌شد / می‌کردم (اما نشد)
...
- I didn't tell her what happened. **She wouldn't have been pleased.**
- It's too bad you couldn't come to the party last night. **You would have enjoyed it.**

---

## 3. Would یا Will (تفاوت)

| Will (واقعیت / امکان) | Would (برخلاف واقعیت / محدودیت) |
|-----------------------|--------------------------------|
...
## 4. کارهای منظم در گذشته (Past Habits)

**معنی:** همیشه / هر بار که ... می‌کردیم
